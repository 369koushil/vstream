              ...
              ${isPlaying && highlightedId === video.id ? "animate-slowPulse" : ""}`}
                >
                  ...
                  <div className="flex flex-col items-center justify-center gap-1">
                    <Button
                      disabled={isPlaying && highlightedId === video.id}
                      size="icon"
                      variant="ghost"
                      className={`h-8 w-8 text-purple-400 hover:text-purple-300 hover:bg-purple-500/10 ${isPlaying && highlightedId === video.id ? "pointer-events-none opacity-50" : ""
                        }`}
                    ...
                    <Button
                      ...
                      size="icon"
                      variant="ghost"
                      className={`h-8 w-8 text-blue-400 hover:text-blue-300 hover:bg-blue-500/10 ${isPlaying && highlightedId === video.id ? "pointer-events-none opacity-50" : ""
                        }`}
